...
export const seedCompanies: CompanyProfile[] = [
  {
    id: "hypothetical-company",
    name: "Dein hypothetisches Unternehmen",
    headquarter: "Nicht hinterlegt",
    serviceRegions: ["Bundesweit"],
    focusAreas: ["cloud", "software-engineering"],
    keywords: ["AWS", "React", "TypeScript", "Monitoring", "CI/CD"],
    certifications: ["ISO 27001", "DSGVO Konzept"],
    minProjectVolume: 90000,
    maxProjectVolume: 420000,
  },
];
